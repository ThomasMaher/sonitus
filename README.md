...
### Development environment for project sonitus. Project sonitus creates an environemnt for learning, communicating, and practicing on audio and music.
...
First, create a dir named: sonitus. Then clone the repo via git:

```bash
git clone git@github.com:ricardomasters/sonitus.git
```
...
Only consider doing this if something breaks in the app.
...
## License
(c) Copyright 2017 Ricardo Gutierrez, all rights reserved.
