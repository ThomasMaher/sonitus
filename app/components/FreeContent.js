  ...
  render() {
    return(
      <section className={styles.container}>
        ...
        <section className={styles.freeContent}>
          <h1>Free Content</h1>
        ...
        <p>Donec eget ex magna. Interdum et malesuada fames ac ante ipsum
          ...
          elit. Pellentesque enim turpis, hendrerit.</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
           rutrum facilisis. Class aptent taciti sociosqu ad litora torquent
            per conubia nostra, per inceptos himenaeos. Etiam tristique libero
            eu nibh porttitor fermentum. Nullam venenatis erat id vehicula
            viverra. Nunc ultrices eros ut ultricies condimentum. Mauris
            risus lacus, blandit sit amet venenatis non, bibendum vitae dolor.
