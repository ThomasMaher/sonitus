...
export default class Mixing0 extends Component {
  render() {
    return(
      <section className={styles.container}>
        ...
        <section className={styles.mixing}>
          ...
          <p>Donec eget ex magna. Interdum et malesuada fames ac ante
            ...
            consectetur id ipsum sit amet, fergiat. Pellentesque in mi eu
            massa lacinia malesuada et a elit. Donec urna ex, lacinia in
             purus ac, pretium pulvinar mauris. Curabitur sapien risus,
             commodo eget turpis at, elementum convallis elit.
